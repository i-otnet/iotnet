...
type SslCertificateOption = "new-certificate" | "own-certificate" | "existing-domain";

export default function BrokerCreateSetup() {
  const [useMqtts, setUseMqtts] = useState(false);
  const [sslOption, setSslOption] = useState<SslCertificateOption>("new-certificate");
        ...
        {useMqtts && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="ssl-certificate-option" className="text-sm font-medium">
                SSL Certificate Option
              </Label>
              <select
                id="ssl-certificate-option"
                value={sslOption}
                onChange={(e) => setSslOption(e.target.value as SslCertificateOption)}
              ...
              >
                <option value="new-certificate">Request a new SSL certificate (with Let&apos;s Encrypt)</option>
                <option value="own-certificate">Use your own certificate</option>
                <option value="existing-domain">Use existing domain SSL (example.com, api.example.com)</option>
              </select>
            </div>
            ...
            {sslOption === "existing-domain" && (
              <div className="space-y-2">
                <Label htmlFor="existing-domain" className="text-sm font-medium">
