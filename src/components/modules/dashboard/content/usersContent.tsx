...
export default function UsersContent() {
  ...
  const filteredUsers = mockUsersData.users.filter(user => {
    ...
    const matchesBroker = filterBroker === "all" || user.brokerType === filterBroker;
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Broker</th>
                    <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Devices</th>
                      ...
                      <tr key={user.id} className="border-b hover:bg-muted/30 transition-colors">
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-2">
                            <div className={`w-6 h-6 rounded-full flex items-center justify-center ${brokerInfo.color}`}>
                              <BrokerIcon className="w-3 h-3" />
                            </div>
                            <div>
                              <div className="font-medium text-sm">{brokerInfo.label}</div>
                              <div className="text-xs text-muted-foreground">{user.brokerName}</div>
                            </div>
                          </div>
                        </td>
                        <td className="p-4">
                          <div className="text-sm font-medium">{user.deviceCount}</div>
