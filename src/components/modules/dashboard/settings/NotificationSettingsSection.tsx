    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between py-3 border-b">
            <div className="space-y-0.5">
              <Label htmlFor="device-alerts" className="text-base">Device Alerts</Label>
              <p className="text-sm text-muted-foreground">Get notified when devices go offline or encounter errors</p>
            </div>
            <input
              type="checkbox"
              id="device-alerts"
          ...
          <div className="flex items-center justify-between py-3 border-b">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Stay informed about system updates and new features</p>
            </div>
            <input
              type="checkbox"
              id="system-updates"
          ...
          <div className="flex items-center justify-between py-3 border-b">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Receive weekly summary of your IoT network activity</p>
            </div>
            <input
              type="checkbox"
              id="weekly-reports"
