...
export default function DashboardOverviewLayout({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="dashboard-overview-section">{dashboardOverview}</div>

      {/* 2. Quick Access Container */}
      <div className="quick-access-section">{quickAccess}</div>

      {/* 3. System Status & 4. Recent Activity Container - Side by Side */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="system-status-section">{systemStatus}</div>
        <div className="recent-activity-section">{recentActivity}</div>
      </div>
