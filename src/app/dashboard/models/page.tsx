...
export default function ModelsPage() {
  ...
  const filteredModels = mockModelsData.models.filter((model) => {
    ...
    const matchesFilter = selectedFilter === "all" || 
                         (selectedFilter === "classification" && model.type.toLowerCase() === "classification") ||
                         (selectedFilter === "regression" && model.type.toLowerCase() === "regression") ||
                         (selectedFilter === "clustering" && model.type.toLowerCase() === "clustering") ||
                         (selectedFilter === "timeseries" && model.type.toLowerCase() === "time series");
  ...
  const getFilteredCount = (filterType: string) => {
    ...
    return mockModelsData.models.filter((model) => {
      ...
      const matchesType = (filterType === "classification" && model.type.toLowerCase() === "classification") ||
                         (filterType === "regression" && model.type.toLowerCase() === "regression") ||
                         (filterType === "clustering" && model.type.toLowerCase() === "clustering") ||
                         (filterType === "timeseries" && model.type.toLowerCase() === "time series");
