...
export default function AutomationsPage() {
  ...
  const filteredAutomations = mockAutomationsData.automations.filter((automation) => {
  ...
  const getFilteredCount = (filterType: string) => {
    ...
    if (filterType === "time") return mockAutomationsData.automations.filter(a => a.type === "Time-based").length;
    if (filterType === "sensor") return mockAutomationsData.automations.filter(a => a.type === "Sensor-based").length;
    if (filterType === "event") return mockAutomationsData.automations.filter(a => a.type === "Event-based").length;
    return 0;
  };
